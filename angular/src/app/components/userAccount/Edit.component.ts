            ...
            <div class="row">
              ...
              <div class="col-12">
                ...
                <div *ngFor="let role of roles" class="form-check">
                  <input id="user_role_role_id{{role.id}}" name="roleId" class="form-check-input" type="checkbox" [value]="role.id" [checked]="userAccountUserRolesChecked('id.roleId', role.id)" />
...
export class UserAccountEdit {
  ...
  userAccountUserRolesChecked(key: string, value: any) { //https://github.com/angular/angular/issues/14129
    return this.userAccountUserRoles?.some(e => this.util.getValueByKeys(e, key) == value)
  }
}