          ...
          <form ngNativeValidate method="post" (submit)="this.delete()">
            <div class="row">
              ...
              <div class="form-group col-md-6 col-lg-4">
                ...
                <input readonly id="customer_name" name="customer_name" class="form-control form-control-sm" value="{{orderHeader.customer && orderHeader.customer.name}}" maxlength="50" />
              </div>
              <div class="form-group col-md-6 col-lg-4">
