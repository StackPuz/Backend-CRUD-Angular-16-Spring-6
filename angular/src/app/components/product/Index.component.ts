            ...
            <table class="table table-sm table-striped table-hover">
              ...
              <tbody>
                <tr *ngFor="let product of products">
                  ...
                  <td class="d-none d-md-table-cell text-center"><a *ngIf="product.image" href="http://localhost:8080/app/uploads/products/{{product.image}}" target="_blank" title="{{product.image}}"><img class="img-list" src="http://localhost:8080/app/uploads/products/{{product.image}}" /></a></td>
                  <td>{{product.name}}</td>
                  <td class="d-none d-md-table-cell text-right">{{product.price}}</td>
                  <td class="d-none d-md-table-cell">{{product.brand && product.brand.name}}</td>
                  <td class="d-none d-md-table-cell">{{product.userAccount && product.userAccount.name}}</td>
