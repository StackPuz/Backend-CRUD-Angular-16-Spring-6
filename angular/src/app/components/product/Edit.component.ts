          ...
          <form ngNativeValidate method="post" (submit)="edit()" enctype="multipart/form-data">
            <div class="row">
              ...
              <div class="form-group col-md-6 col-lg-4">
                ...
                <select id="product_brand_id" name="brand.id" class="form-control form-control-sm" [(ngModel)]="product.brand && product.brand.id" required>
              ...
              <div class="form-group col-md-6 col-lg-4">
                ...
                <a href="http://localhost:8080/app/uploads/products/{{product.image}}" target="_blank" title="{{product.image}}"><img class="img-item" src="http://localhost:8080/app/uploads/products/{{product.image}}" /></a>
