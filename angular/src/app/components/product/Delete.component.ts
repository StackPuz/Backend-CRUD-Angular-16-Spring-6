          ...
          <form ngNativeValidate method="post" (submit)="this.delete()">
            <div class="row">
              ...
              <div class="form-group col-md-6 col-lg-4">
                ...
                <input readonly id="brand_name" name="brand_name" class="form-control form-control-sm" value="{{product.brand && product.brand.name}}" maxlength="50" />
              </div>
              <div class="form-group col-md-6 col-lg-4">
                <label for="user_account_name">Create User</label>
                <input readonly id="user_account_name" name="user_account_name" class="form-control form-control-sm" value="{{product.userAccount && product.userAccount.name}}" maxlength="50" />
              </div>
              <div class="form-group col-md-6 col-lg-4"><label>Image</label>
                <div><a href="http://localhost:8080/app/uploads/products/{{product.image}}" target="_blank" title="{{product.image}}"><img class="img-item" src="http://localhost:8080/app/uploads/products/{{product.image}}" /></a></div>
              </div>
              <div class="col-12">
